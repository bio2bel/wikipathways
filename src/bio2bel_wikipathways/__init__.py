...
WikiPathways is a pathway database containing multiple pathways for different species. This package downloads pathway information from its API and store it in template data model relating genes to pathways.
